...
} from "@/features/roadmap/hooks/use-roadmap";
        ...
        <CardContent className="p-5">
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <h2 className="text-base font-bold leading-snug text-foreground">{roadmap.title}</h2>
...
function EmptyState({
  ...
  return (
    <motion.div initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }}>
      <Card className="glass-card mx-auto mt-12 max-w-xl border-border/50">
        ...
        <CardContent className="pb-6">
          ...
          <div className="flex justify-center">
            <Button size="lg" onClick={onGenerate} disabled={isGenerating} className="gap-2 px-8">
              {isGenerating ? (
