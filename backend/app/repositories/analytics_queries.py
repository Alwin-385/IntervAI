...
class AnalyticsQueryRepository:
    ...
    async def list_answer_evaluations_for_user(self, user_id: UUID) -> list[tuple[AnswerEvaluation, InterviewAnswer, InterviewQuestion, InterviewSession]]:
        stmt = (
    ...
    async def list_speech_analyses_for_user(self, user_id: UUID) -> list[tuple[SpeechAnalysis, InterviewSession]]:
        stmt = (
