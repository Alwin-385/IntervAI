...
async def get_weak_areas_analytics(
    ...
    service: Annotated[WeakAreaDetectionEngineService, Depends(get_weak_area_detection_engine_service)],
...
async def get_analytics_dashboard(
    current_user: Annotated[User, Depends(get_current_user)],
    service: Annotated[AnalyticsDashboardEngineService, Depends(get_analytics_dashboard_engine_service)],
